...
function Mission4() {
  ...
  return (
    <div className={`mission-container ${isRTL ? "rtl" : "ltr"}`}>
      ...
      <div className="mission-header">
        ...
        <FavoriteButton track="darija" missionNum={4} />
  ...
  <span>{item.word}</span>
  <SaveVocabButton id={'darija_4_' + item.word} word={item.word} translation={item.en} track="darija" missionNum={4} />
</div>
  ...
  <SaveVocabButton id={'darija_4_' + exp.darija} word={exp.darija} translation={exp.en || exp.fr} track="darija" missionNum={4} type="expression" />
</div>
