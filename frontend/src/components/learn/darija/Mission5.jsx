          ...
          {step === "completion" && (
            <div className="completion-step">
              ...
              <div className="next-mission-card">
                <div className="next-icon"><span style={{ fontSize: "1.5rem" }}>🔓</span></div>
                <div className="next-info">
                  <h4>{lang === "FR" ? "Prochaine Mission : Demander son Chemin" : lang === "AR" ? "المهمة القادمة: طلب الاتجاهات" : "Next Mission: Asking Directions"}</h4>
                </div>
              </div>
